...
<template>
  ...
  >
    <SwitchThumb
      :class="cn('pointer-events-none block h-20 w-20 rounded-full bg-background shadow-512 ring-0 transition-transform data-[state=checked]:translate-x-20 data-[state=unchecked]:translate-x-0')"
    />
  </SwitchRoot>
</template>
