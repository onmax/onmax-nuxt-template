...
<template>
  <DialogPortal>
    ...
    >
      ...
      <DialogClose
        class="absolute right-16 top-16 opacity-70 ring-offset-background transition-opacity f-rounded disabled:pointer-events-none data-open:bg-accent data-open:text-muted-foreground hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring"
      >
        <X class="h-16 w-16" />
