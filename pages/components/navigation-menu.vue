              ...
              <NavigationMenuList>
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                    <ul class="grid gap-12 p-24 lg:grid-cols-[minmax(0,.75fr)_minmax(0,1fr)] lg:w-[500px] md:w-[400px]">
                      <li class="row-span-3">
                ...
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent>
                    <ul class="grid w-[400px] gap-12 p-16 md:grid-cols-2 lg:w-[600px] md:w-[500px]">
                      <NavigationMenuDemoItem
